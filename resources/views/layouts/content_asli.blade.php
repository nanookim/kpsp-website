            ...
            <div class="card-body">
                ...
                <div class="greeting-user text-center">
                    <div class="profile-vector"><img class="img-fluid"
                                                     src="{{asset('cuba')}}/images/dashboard/welcome.png"
                                                     alt=""></div>
                            ...
                            <table class="table table-bordernone">
                                ...
                                <tr>
                                    <td><img class="img-fluid img-40 rounded-circle mb-3"
                                             src="{{asset('cuba')}}/images/appointment/app-ent.jpg"
                    ...
                    <div class="media-body">
                        <div class="d-flex mb-3">
                            <div class="inner-img"><img class="img-fluid"
                                                        src="{{asset('cuba')}}/images/notification/1.jpg"
                                                        alt="Product-1"></div>
                            <div class="inner-img"><img class="img-fluid"
                                                        src="{{asset('cuba')}}/images/notification/2.jpg"
                                                        alt="Product-2"></div>
                        </div>
                    ...
                    <div class="media left-side-chat">
                        <div class="media-body d-flex">
                            <div class="img-profile"><img class="img-fluid"
                                                          src="{{asset('cuba')}}/images/user.jpg"
                                                          alt="Profile"></div>
                            <div class="main-chat">
